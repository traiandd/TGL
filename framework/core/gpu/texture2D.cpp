...
const GLint internalFormat[][5] = {{0, GL_R8, GL_RG8, GL_RGB8, GL_RGBA8},
...
GLuint Texture2D::GetTextureID() const { return textureID; }
...
void Texture2D::CacheInMemory(bool state) { cacheInMemory = state; }
...
unsigned char *Texture2D::GetImageData() const { return imageData; }

unsigned int Texture2D::GetNrChannels() const { return channels; }
