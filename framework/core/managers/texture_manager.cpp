...
void TextureManager::Init(const std::string &selfDir) {
	...
	LoadTexture(PATH_JOIN(selfDir, RESOURCE_PATH::TEXTURES), "meme.png");
	LoadTexture(PATH_JOIN(selfDir, RESOURCE_PATH::TEXTURES), "cioroles.jpeg");
	LoadTexture(PATH_JOIN(selfDir, RESOURCE_PATH::TEXTURES), "weed.jpeg");
	LoadTexture(PATH_JOIN(selfDir, RESOURCE_PATH::TEXTURES), "bile.jpeg");
	LoadTexture(PATH_JOIN(selfDir, RESOURCE_PATH::TEXTURES), "tree.png");
	LoadTexture(PATH_JOIN(selfDir, RESOURCE_PATH::TEXTURES), "polish_baby.png");
...
void TextureManager::SetTexture(std::string name, Texture2D *texture) { mapTextures[name] = texture; }
